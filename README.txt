...
![The geofencing tool](/images/geofence-page.png?raw=true "The geofencing tool")

The geofences appear in the Hover app when geofence is inserted in DB. 

![The map view in the app Hover](/images/hover-geofences.jpg?raw=true "The map view in the app Hover")
